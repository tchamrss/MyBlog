...
MY_MAIL_APP_PW = os.environ.get("PASSWORD_KEY")
...
def send_email(name, email, phone, message):
    ...
    with smtplib.SMTP("smtp.gmail.com", 587) as connection:
        ...
        # Create the email message (because i have non ascii character)
        msg = MIMEMultipart()
        msg['From'] = email
        msg['To'] = MY_MAIL_ADDRESS
        msg['Subject'] = f"Contact {name} - Phone {phone} from blog"
